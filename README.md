...
pipeline {
    ...
    stages {
        ...
        stage ("Git checkout") {
            steps {
                git branch: 'main', 
                url: 'https://github.com/AungAung-Drlinuxer/background-remover-python-app.git'
            }
        }
        ...
        stage("Trivy Image Scan") {
            steps {
                sh "trivy image background-remover-python-app > trivyimage.txt"
                script {
                    input(message: "Review Trivy Image scan. Proceed to Push?", ok: "Proceed")
                }
            }
        }
            ...
            steps {
                script {
                    withDockerRegistry(credentialsId: 'docker') {
                        sh "docker tag background-remover-python-app aungaungmyomyint/background-remover-python-app:latest"
                        sh "docker push aungaungmyomyint/background-remover-python-app:latest"
                    }
                }
            }
        }
            ...
            steps {
                script {
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker') {
                       sh 'docker-scout quickview aungaungmyomyint/background-remover-python-app:latest'
                       sh 'docker-scout cves aungaungmyomyint/background-remover-python-app:latest'
                       sh 'docker-scout recommendations aungaungmyomyint/background-remover-python-app:latest'
                   }
                }
            }
        }
        ...
        stage ("Deploy to Container") {
            steps {
                sh 'docker run -d --name background-remover-python-app -p 5100:5100 aungaungmyomyint/background-remover-python-app:latest'
            }
        }
    }
    ...
    always {
        emailext attachLog: true,
            ...
            """,
            to: 'aungaungmyomyint.aa@gmail.com',
            mimeType: 'text/html',
